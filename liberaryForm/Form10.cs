...
namespace liberaryForm
{
    public partial class Form10 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            con.Open();
            cmd.CommandText = "Select * from Customer where UserID = '" + textBox4.Text + "'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE Customer SET Name = '" + name + "' ,  Password = '" + password + "' ,Email = '" + email + "' WHERE UserID = " + id;
